...
def test_expected_input_tables_success():
    ...
    assert res.message == "in_a, in_b, in_c"


def test_expected_input_tables_empty():
    action = ExpectedInputTablesAction()
...
def test_expected_input_tables_error(monkeypatch):
    action = ExpectedInputTablesAction()
    ...
    assert "Error analyzing expected input tables" in res.message


def test_expected_input_tables_filters_cte_aliases_only():
    ...
    assert res.message == "raw_data"


def test_expected_input_tables_create_without_inputs():
